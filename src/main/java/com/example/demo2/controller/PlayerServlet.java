...
import com.example.demo2.dao.PlayerDAO;
import com.example.demo2.entity.Player;
...
public class PlayerServlet extends HttpServlet {
        ...
        try {
            switch (action) {
                ...
                default:
                    ...
                    RequestDispatcher listDispatcher = req.getRequestDispatcher("player/playerlist.jsp");
    ...
    private void renderForm(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        RequestDispatcher formDispatcher = req.getRequestDispatcher("player/playerform.jsp");
